...
import checkvn.com.viettiepbhdt.utils.Constants.VERIFY_CODE_WARRANTY_STAFF
...
class WalkThoughInfoFragment : BaseWalkThoughFragment() {
    ...
    private fun validateDataUser(): Boolean {
        ...
        if (userTypeSelected == 1) {
            ...
            if (edtAgencyCode.text.isNullOrEmpty()) {
                ...
                isValidate = false
            } else if (edtAgencyCode.text.toString() != VERIFY_CODE_WARRANTY_STAFF) {
                tvAgencyCodeError.isVisible = true
